...
export class HeroeService {
  ...
  //retorna el array con todos los datos de los heores 
  getHeroes(): Heroe[]{
    return this.heroes;
  }

  //retorna en especial los datos del superheroe solicitado
  getHeroe(i: number): Heroe{
    return this.heroes[i];
  }

  //retorna el indice donde se encuentra el superheroe buscado
